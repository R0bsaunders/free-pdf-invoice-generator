...
form.addEventListener('submit', (e) => {
    ...
    fetch('https://invoice-generator-2i0i21f41-r0bsaunders-projects.vercel.app:3000/invoice', {
        method: "POST",
        body: urlencoded,
        headers: {
...
getInvoice.addEventListener('click', (e) => {
    ...
    fetch('https://invoice-generator-2i0i21f41-r0bsaunders-projects.vercel.app:1234', {
        method: "GET"
